 ...
 *                                                                               generated by [keymapviz] */
    [_BASE] = LAYOUT_split_3x6_3(
        ...
        KC_NO,   KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,         KC_K,    KC_H,    KC_COMM, TD_DOT,  KC_SLSH, KC_NO,
 ...
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      | HOME | PGUP |  UP  | PGDN | END  |                | LEFT | DOWN |  UP  | RGHT | F11  |      |
 * |------+------+------+------+------+------|                |------+------+------+------+------+------|
 * |      | MUTE | VOLD | VOLU |      |      |                |      |      |      |      | F12  |      |
 * `------+------+------+------+------+------+------.  ,------+------+------+------+------+------+------|
 *                             |      |      |      |  |      |      |      |
 ...
 *                                                                               generated by [keymapviz] */
    [_RAISE] = LAYOUT_split_3x6_3(
        ...
        KC_NO,   KC_HOME, KC_PGUP, KC_UP,   KC_PGDN, KC_END,       KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_F11,  KC_NO,
        KC_NO,   KC_MUTE, KC_VOLD, KC_VOLU, _______, _______,      _______, _______, _______, _______, KC_F12,  KC_NO,
